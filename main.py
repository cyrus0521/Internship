...
def q(a, n):
    ...
    # print
    # The number of strings of length N from alphabet A with ≥ 2 distinct cyclic rotations
    # The number of strings of length N from alphabet A with exactly N distinct cyclic rotations.
    # The number of strings of length N from alphabet A with exactly 1 distinct cyclic rotation.
    # Is the number of strings with ≥2 distinct cyclic rotations an integer multiple of N
    print(f'{total - a} {total - a - repetition_sum} {a} {(total - a) % n == 0}')


if __name__ == "__main__":
    # _, a, n = sys.argv    # a = types of char, n = length of string
    a = 3
    n = 6
    q(int(a), int(n))
